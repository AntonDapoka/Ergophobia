...
namespace MG_BlocksEngine2.DragDrop
{
    public class BE2_Raycaster : MonoBehaviour, I_BE2_Raycaster
    {
        ...
        public I_BE2_Spot FindClosestConnectableSpot(I_BE2_Drag drag, float maxDistance)
        {
            ...
            {
                I_BE2_Spot spot = _dragDropManager.SpotsList[i];
                I_BE2_ProgrammingEnv programmingEnv = spot.Transform.GetComponentInParent<BE2_ProgrammingEnv>();
        ...
        public I_BE2_Block FindClosestConnectableBlock(I_BE2_Drag drag, float maxDistance)
        {
            ...
            I_BE2_ProgrammingEnv activeEnv = null;
            ...
            if (activeEnv != null)
            {
                ...
                {
                    I_BE2_Block block = child.GetComponent<I_BE2_Block>();
                    if (block != null && !(block is BE2_GhostBlock) && (block.Type != BlockTypeEnum.define && block.Type != BlockTypeEnum.operation && block.Type != BlockTypeEnum.trigger))
                    {
