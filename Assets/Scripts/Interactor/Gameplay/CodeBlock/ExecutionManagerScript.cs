...
public class ExecutionManagerScript : MonoBehaviour
{
    List<IBehaviourInteractor> _targetObjectsList;

    List<IProgrammingEnvironment> _programmingEnvsList;
    // v2.7 - added public ProgrammingEnvsList property to the Execution Manager
    public List<IProgrammingEnvironment> ProgrammingEnvsList => _programmingEnvsList;
    // v2.1 - blocksStack array of the ExecutionManager made public
    //public IBlocksStack[] blocksStacksArray; !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

    // v2.7 - Execution Manager instance changed to property to guarantee return
    static ExecutionManagerScript _instance;
    public static ExecutionManagerScript Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindAnyObjectByType<ExecutionManagerScript>();
            }
            return _instance;
        }
        set => _instance = value;
    ...
    void Awake()
    {
        _pointer = PointerScript.Instance;
